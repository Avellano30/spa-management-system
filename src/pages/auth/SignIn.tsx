  ...
  return (
    <>
      <div className="min-h-screen flex items-center justify-center">
        <div className="max-w-98.5 w-full rounded-lg">
          <div className="px-10 py-8 rounded-lg shadow-lg">
            ...
            <h2 className="text-[17px] font-bold text-center text-[#e50914] mb-8">
              Admin
            </h2>
            <h2 className="text-[17px] font-bold text-center">
              Spa Management System
            </h2>
            <p className="text-[13px] mb-8 text-center">
              Welcome back! Please sign in to continue
            </p>
            <button
              type="button"
              className="flex w-full py-1.5 px-3 justify-center items-center border border-black rounded-md font-semibold text-[13px] hover:drop-shadow-md"
              onClick={() => login()}
              data-testid="google-login-button"
            >
              <FcGoogle className="text-[17px] mr-2" />
              Continue with Google
            </button>
            <div className="my-4">
              <Divider
                my="xs"
                label={<span className="text-black">or</span>}
            ...
            >
              ...
              {errorMessage && (
                <p
                  className="text-[#e50914] text-[13px] font-semibold"
